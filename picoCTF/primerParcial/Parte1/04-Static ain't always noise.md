...
Utilizamos "wget" para descargar los archivos que nos especifican y de ahi utilizamos el comando "strings  I  grep pico"

## Solution

```
VFlours-picoctf@webshell:~$ strings static 
...
.bss
.comment
VFlours-picoctf@webshell:~$ strings static | grep pico
picoCTF{d15a5m_t34s3r_1e6a7731}
